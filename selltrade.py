class Trade:
    def __init__(self, trade_type: str, instrument_name: str, order_type: str = "limit", amount: float = None, 
                 contracts: int = None, label: str = None, price: float = None, 
                 time_in_force: str = "good_til_cancelled", max_show: int = 0, post_only: bool = False, 
                 reject_post_only: bool = False, reduce_only: bool = False, trigger_price: float = None, 
                 trigger_offset: float = None, trigger: str = None, advanced: str = None, mmp: bool = False, 
                 valid_until: int = None, linked_order_type: str = None, 
                 trigger_fill_condition: str = "first_hit", otoco_config: list = None):
        """
        Initialize a Trade object with all necessary parameters for the /private/buy or /private/sell endpoint.

        :param trade_type: str - Type of trade, either 'buy' or 'sell'.
